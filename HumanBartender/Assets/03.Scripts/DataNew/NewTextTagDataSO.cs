...
/// <summary>
/// settings/text_tags.csv의 항목 하나. 태그 이름 -> 이 값의 딕셔너리로 읽는다.
///
...
/// <summary>
/// StreamingAssets/csv/settings/text_tags.csv를 보유하는 ScriptableObject.
/// 루트가 태그 이름 -> 태그 정의의 딕셔너리다.
///
/// DialogueTextCompiler가 color, speed_ms, size_pct를 사용한다. ColorTags는 레거시
/// 색상 전용 호출부를 위한 필터다.
/// </summary>
